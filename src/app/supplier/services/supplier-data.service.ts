...
export class SupplierDataService {
  ...
  private mapToParcel(req: any): Parcel {
    ...
    return {
      ...
      description: pkg.description || req.description || req.Description || parcelObj.description || 'Shipment without description',
      weight: pkg.weight || req.weight || req.Weight || parcelObj.weight || 1,
      dimensions: pkg.dimensions || req.dimensions || parcelObj.dimensions || '',
      pickupAddress: req.source || req.pickupAddress || req.Source || parcelObj.pickupAddress || 'Pickup Address',
      deliveryAddress: pkg.destination || req.deliveryAddress || req.Destination || parcelObj.deliveryAddress || 'Delivery Address',
      receiverName: pkg.receiverName || pkg.customerName || req.receiverName || req.CustomerName || pkg.receiverName || parcelObj.receiverName || 'Customer',
